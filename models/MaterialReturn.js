...
const materialReturnSchema = new mongoose.Schema({
  ...
  stage: {
    type: String,
    enum: ['Initiated', 'Approved', 'Transport_Pickup', 'In_Transit', 'Out_For_Delivery', 'Delivered', 'Warehouse_Queue', 'Received_At_Warehouse', 'QC_In_Progress', 'QC_Completed', 'Closed'],
    default: 'Initiated',
  },
  ...
  currentWorkflowStage: { 
    type: String, 
    enum: ['Return_Created', 'Invoice_Validation', 'Tracking_Start', 'Warehouse_Receiving', 'QC_Check', 'Stock_Ledger_Entry', 'Finance_Settlement', 'Reconciliation_Engine', 'Tally_Sync'],
