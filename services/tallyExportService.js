...
<BODY><DESC>
  ...
  <TDL><TDLMESSAGE>
    ...
    const autoLedgerXml = [
      ...
      // GSTCLASSFNRATES.LIST is the correct Tally structure to set the GST rate on a ledger.
      `<LEDGER NAME="CGST" ACTION="Alter"><NAME>CGST</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><RATEOFTAXCALCULATION>0</RATEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="SGST" ACTION="Alter"><NAME>SGST</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><RATEOFTAXCALCULATION>0</RATEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="IGST" ACTION="Alter"><NAME>IGST</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><RATEOFTAXCALCULATION>0</RATEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="Output CGST @ 2.5%" ACTION="Alter"><NAME>Output CGST @ 2.5%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><RATEOFTAXCALCULATION>2.5</RATEOFTAXCALCULATION><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>CGST</DUTYTYPE><GSTRATEDUTYHEAD>CGST</GSTRATEDUTYHEAD><GSTRATE>2.5</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output SGST @ 2.5%" ACTION="Alter"><NAME>Output SGST @ 2.5%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><RATEOFTAXCALCULATION>2.5</RATEOFTAXCALCULATION><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>SGST/UTGST</DUTYTYPE><GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD><GSTRATE>2.5</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output CGST @ 6%" ACTION="Alter"><NAME>Output CGST @ 6%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><RATEOFTAXCALCULATION>6</RATEOFTAXCALCULATION><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>CGST</DUTYTYPE><GSTRATEDUTYHEAD>CGST</GSTRATEDUTYHEAD><GSTRATE>6</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output SGST @ 6%" ACTION="Alter"><NAME>Output SGST @ 6%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><RATEOFTAXCALCULATION>6</RATEOFTAXCALCULATION><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>SGST/UTGST</DUTYTYPE><GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD><GSTRATE>6</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output CGST @ 9%" ACTION="Alter"><NAME>Output CGST @ 9%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><RATEOFTAXCALCULATION>9</RATEOFTAXCALCULATION><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>CGST</DUTYTYPE><GSTRATEDUTYHEAD>CGST</GSTRATEDUTYHEAD><GSTRATE>9</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output SGST @ 9%" ACTION="Alter"><NAME>Output SGST @ 9%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><RATEOFTAXCALCULATION>9</RATEOFTAXCALCULATION><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>SGST/UTGST</DUTYTYPE><GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD><GSTRATE>9</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output IGST @ 5%" ACTION="Alter"><NAME>Output IGST @ 5%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><RATEOFTAXCALCULATION>5</RATEOFTAXCALCULATION><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>IGST</DUTYTYPE><GSTRATEDUTYHEAD>IGST</GSTRATEDUTYHEAD><GSTRATE>5</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output IGST @ 12%" ACTION="Alter"><NAME>Output IGST @ 12%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><RATEOFTAXCALCULATION>12</RATEOFTAXCALCULATION><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>IGST</DUTYTYPE><GSTRATEDUTYHEAD>IGST</GSTRATEDUTYHEAD><GSTRATE>12</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output IGST @ 18%" ACTION="Alter"><NAME>Output IGST @ 18%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><RATEOFTAXCALCULATION>18</RATEOFTAXCALCULATION><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>IGST</DUTYTYPE><GSTRATEDUTYHEAD>IGST</GSTRATEDUTYHEAD><GSTRATE>18</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      ...partyNames.map(name =>
