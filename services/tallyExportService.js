...
<BODY><DESC>
  ...
  <TDL><TDLMESSAGE>
    ...
    const autoLedgerXml = [
      ...
      // ACTION="Alter" + RATEOFTAXCALCULATION ensures the rate is SET even if the
      // ledger already existed with 0% (which is what caused the e-invoice warning).
      ...
      `<LEDGER NAME="Output CGST @ 2.5%" ACTION="Alter"><NAME>Output CGST @ 2.5%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><PERCENTAGEOFTAXCALCULATION>2.5</PERCENTAGEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="Output SGST @ 2.5%" ACTION="Alter"><NAME>Output SGST @ 2.5%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><PERCENTAGEOFTAXCALCULATION>2.5</PERCENTAGEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="Output CGST @ 6%" ACTION="Alter"><NAME>Output CGST @ 6%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><PERCENTAGEOFTAXCALCULATION>6</PERCENTAGEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="Output SGST @ 6%" ACTION="Alter"><NAME>Output SGST @ 6%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><PERCENTAGEOFTAXCALCULATION>6</PERCENTAGEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="Output CGST @ 9%" ACTION="Alter"><NAME>Output CGST @ 9%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><PERCENTAGEOFTAXCALCULATION>9</PERCENTAGEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="Output SGST @ 9%" ACTION="Alter"><NAME>Output SGST @ 9%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><PERCENTAGEOFTAXCALCULATION>9</PERCENTAGEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="Output IGST @ 5%" ACTION="Alter"><NAME>Output IGST @ 5%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><PERCENTAGEOFTAXCALCULATION>5</PERCENTAGEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="Output IGST @ 12%" ACTION="Alter"><NAME>Output IGST @ 12%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><PERCENTAGEOFTAXCALCULATION>12</PERCENTAGEOFTAXCALCULATION></LEDGER>`,
      `<LEDGER NAME="Output IGST @ 18%" ACTION="Alter"><NAME>Output IGST @ 18%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><PERCENTAGEOFTAXCALCULATION>18</PERCENTAGEOFTAXCALCULATION></LEDGER>`,
      ...partyNames.map(name =>
