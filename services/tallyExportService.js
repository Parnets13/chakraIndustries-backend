...
<BODY><DESC>
  ...
  <TDL><TDLMESSAGE>
    ...
    const autoLedgerXml = [
      ...
      `<LEDGER NAME="Output CGST @ 2.5%" ACTION="Alter"><NAME>Output CGST @ 2.5%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>CGST</DUTYTYPE><GSTRATEDUTYHEAD>CGST</GSTRATEDUTYHEAD><GSTRATE>2.5</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output SGST @ 2.5%" ACTION="Alter"><NAME>Output SGST @ 2.5%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>SGST/UTGST</DUTYTYPE><GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD><GSTRATE>2.5</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output CGST @ 6%" ACTION="Alter"><NAME>Output CGST @ 6%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>CGST</DUTYTYPE><GSTRATEDUTYHEAD>CGST</GSTRATEDUTYHEAD><GSTRATE>6</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output SGST @ 6%" ACTION="Alter"><NAME>Output SGST @ 6%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>SGST/UTGST</DUTYTYPE><GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD><GSTRATE>6</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output CGST @ 9%" ACTION="Alter"><NAME>Output CGST @ 9%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Central Tax</TAXTYPE><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>CGST</DUTYTYPE><GSTRATEDUTYHEAD>CGST</GSTRATEDUTYHEAD><GSTRATE>9</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output SGST @ 9%" ACTION="Alter"><NAME>Output SGST @ 9%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>State Tax</TAXTYPE><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>SGST/UTGST</DUTYTYPE><GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD><GSTRATE>9</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output IGST @ 5%" ACTION="Alter"><NAME>Output IGST @ 5%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>IGST</DUTYTYPE><GSTRATEDUTYHEAD>IGST</GSTRATEDUTYHEAD><GSTRATE>5</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output IGST @ 12%" ACTION="Alter"><NAME>Output IGST @ 12%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>IGST</DUTYTYPE><GSTRATEDUTYHEAD>IGST</GSTRATEDUTYHEAD><GSTRATE>12</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      `<LEDGER NAME="Output IGST @ 18%" ACTION="Alter"><NAME>Output IGST @ 18%</NAME><PARENT>Duties &amp; Taxes</PARENT><TAXTYPE>Integrated Tax</TAXTYPE><GSTCLASSFNRATES.LIST ACTION="Replace"><DUTYTYPE>IGST</DUTYTYPE><GSTRATEDUTYHEAD>IGST</GSTRATEDUTYHEAD><GSTRATE>18</GSTRATE></GSTCLASSFNRATES.LIST></LEDGER>`,
      ...partyNames.map(name =>
