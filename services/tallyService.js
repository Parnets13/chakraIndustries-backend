...
export async function pushSalesVouchersToTally(cfg, triggeredBy) {
  ...
  try {
    ...
    const autoLedgerXml = [
      ...
      `<LEDGER NAME="Sales Accounts" ACTION="Create"><NAME>Sales Accounts</NAME><PARENT>Sales Accounts</PARENT></LEDGER>`,
      // Rate-specific GST ledgers: correct Tally Prime structure
      // TAXTYPE = Central Tax/State Tax/Integrated Tax + SUBTYPE + RATEOFTAXCALCULATION
      // TAXTYPE="Others" was wrong — shows "Others" type with 0% on print.
